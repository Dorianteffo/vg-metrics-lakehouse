...
def generate_data(fake : Faker
    ...
    for _ in range(10000):
        data.append({
            ...
            'Critics_Score': fake.random_number(digits=2),
            'User_Score': fake.random_number(digits=2),
            'Metacritic_Score': fake.random_number(digits=2),
            'IGN_Score': fake.random_number(digits=2),
            ...
            'Main_Story_Length': fake.random_number(digits=2),
            'Completionist_Length': fake.random_number(digits=2),
            'Achievements': fake.random_number(digits=2),
            ...
            'Download_Size': fake.random_number(digits=4),
            'Community_Rating': fake.random_number(digits=2),
            'Player_Count': fake.random_number(digits=5),
